  ...
  return (
    <>
      <div className="m-8 max-w-4xl mx-auto px-8 mt-4">
        ...
        <p className="mb-4">Welcome to heisenblogz!</p>

        <p className="mb-4">
          These terms and conditions outline the rules and regulations for the
          use of heisenblogz's Website, located at https://heisenblogz.in.
        </p>

        <p className="mb-4">
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use heisenblogz if you do not agree to
        ...
        <p className="mb-4">
          We employ the use of cookies. By accessing heisenblogz, you agree to
          use cookies in agreement with the heisenblogz's Privacy Policy.{" "}
        </p>
        ...
        <p className="mb-4">
          Unless otherwise stated, heisenblogz and/or its licensors own the
          intellectual property rights for all material on heisenblogz. All
          intellectual property rights are reserved. You may access this from
          heisenblogz for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <ul className="list-disc list-inside mb-4">
          <li>Republish material from heisenblogz</li>
          <li>Sell, rent or sub-license material from heisenblogz</li>
          <li>Reproduce, duplicate or copy material from heisenblogz</li>
          <li>Redistribute content from heisenblogz</li>
        </ul>
        ...
        <p className="mb-4">
          ...
          heisenblogz does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of heisenblogz,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, heisenblogz
          shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>

        <h3 className="text-xl font-bold mb-2">Hyperlinking to our Content</h3>
        ...
        <p className="mb-4">
          ...
          the hyperlink compensates the absence of heisenblogz; and (d) the link
        ...
        <p className="mb-4">
          ...
          sending an e-mail to heisenblogz. Please include your name, your
        ...
        <p className="mb-4">
          No use of heisenblogz's logo or other artwork will be allowed for
          linking absent a trademark license agreement.
        </p>

        <h3 className="text-xl font-bold mb-2">iFrames</h3>
        ...
        <h3 className="text-xl font-bold mb-2">Content Liability</h3>
        ...
        <p className="mb-4">
          ...
          may be interpreted as libelous, obscene, criminal, or which infringes,
          violates, or advocates the infringement or violation of any third
          party rights.
        </p>
