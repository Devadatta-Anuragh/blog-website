        ...
        <ul>
          ...
          <li>
            <p className="mb-4">
              ...
              in this Agreement) refers to HeisenBlogz.
            </p>
          </li>
          <li>
            <p className="mb-4">
          ...
          <li>
            <p className="mb-4">
              <strong>Website</strong> refers to HeisenBlogz, accessible from{" "}
              <a
                href="https://heisenblogz.in"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://heisenblogz.in
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p className="mb-4">
              ...
              <a
                href="https://heisenblogz.in/about"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://heisenblogz.in/about
              </a>
            </p>
          </li>
        </ul>
